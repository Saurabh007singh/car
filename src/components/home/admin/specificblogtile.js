...
export function SpecificBlogTile({
  product,
  setCurrentEditedId,
  setFormData,
...

{
  ...
  return (
    <div className="w-full flex flex-col border-4  justify-between max-w-sm mx-auto">
      <div
        className="relative h-auto cursor-pointer"
        onClick={() => {
          router.push(`/dashboard/blogs/specifcblogs/${product._id}`);
        }}
      >

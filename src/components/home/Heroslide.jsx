  ...
  return (
    ...
    >
      ...
      <motion.div initial={{ x: -300, opacity: 0 }}
        animate={{ x: 0, opacity: 1 }}
        transition={{ duration: 1, ease: "easeOut" }} className="absolute z-20 inset-0 flex flex-col items-start top-20 gap-7 px-4 text-white">
        ...
        <HoverButton text="KNOW MORE" height="60px" width="200px" />
      </motion.div>
    </motion.section>
  );
}

...
export function PortfolioCard({ _id, images, cardHeading, cardSubHeading }) {
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden shadow-lg bg-black md:h-[500px] h-[400px] "
    ...
    >
      ...
      >
        <div className="flex flex-col gap-4 p-2">
          ...
          <div onClick={() => router.push(`/home/portfolio/${_id}`)}>

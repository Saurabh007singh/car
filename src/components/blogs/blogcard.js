...
export function BlogCard({ _id, images, cardHeading, cardSubHeading }) {
  ...
  return (
    ...
    >
      ...
      <img
        src={images[0]}
        alt={cardHeading}
        className="lg:object-cover object-fit md:h-[500px] h-[400px] transition-opacity duration-300"
      />
      ...
      >
        <div className="flex flex-col gap-4 p-2">
          ...
          <div onClick={() => router.push(`/home/blogs/${_id}`)}>

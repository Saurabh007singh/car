...
export async function POST(req, { params }) {
  ...
  await SpecificPortfolio.findOneAndUpdate({ id: bannerId }, { $set: { images: [] } });
  ...
  for (const file of files) {
    ...
    const fileUrl = `/uploads/portfolio/specificportfolio/${bannerId}/${safeName}`;
  ...
  const updatedBanner = await SpecificPortfolio.findOneAndUpdate(
    { id: bannerId },

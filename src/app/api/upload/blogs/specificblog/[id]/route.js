...
export async function POST(req, { params }) {
  ...
  await SpecificBlog.findOneAndUpdate({ id: bannerId }, { $set: { images: [] } });
  ...
  for (const file of files) {
    ...
    const fileUrl = `/uploads/blog/specificblog/${bannerId}/${safeName}`;
  ...
  const updatedBanner = await SpecificBlog.findOneAndUpdate(
    { id: bannerId },

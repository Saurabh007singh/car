...
export async function POST(req, { params }) {
  ...
  await Portfolio.findByIdAndUpdate(serviceId, { $set: { images: [] } });
  ...
  for (const file of files) {
    ...
    const fileUrl = `/uploads/home/portfolio/${serviceId}/${safeName}`;
  ...
  const updatedBanner = await Portfolio.findByIdAndUpdate(
    serviceId,
